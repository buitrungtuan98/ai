...
| `main.py` | web | FastAPI app: login/session, dashboard (health/counts), campaigns CRUD+edit+duplicate+performance page (form incl. colour grade + Auto-QC), asset review (reason→learning), streaming, task API+retry, credential tests, OAuth | HTTP | HTML/JSON | fastapi, auth, models, task_queue | DONE | 2026-07-19 |
| `templates/` | web | Jinja2 dashboard (6 pages) + standalone login.html; sidebar session chip; Asset Pool shows Auto-QC verdicts | context | HTML | jinja2 | DONE | 2026-07-19 |
